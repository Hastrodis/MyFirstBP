...
{
    public abstract class MyFirstBPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyFirstBPWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyFirstBPWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyFirstBPDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyFirstBPDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyFirstBPDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyFirstBPDbContext, Task<T>> func)
        {
            T result;
